...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet" ">
  ...
  <body oncontextmenu="return false" class="snippet-body">
    ...
    <label for="inputAddress" class="form-label">Business Number</label>
                 <input type="text" class="form-control" name="number" placeholder="Enter Business Number">
               </div>
               <div class="col-12">
                 <label for="inputAddress2" class="form-label" >Account Number</label>
